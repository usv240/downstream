...
Captured against the deployed service at 1600x1000, two-times scale, by
`docs/gallery` automation rather than by hand, so the numbers in them are a real run rather than a
mock-up.

| File | What it shows |
|---|---|
| `01-landing.png` | The problem, the measured inventory snapshot, and the three ways in |
| `02-one-request-run.png` | The autonomy receipt after one request: 15 automatic steps, 0 continue clicks |
